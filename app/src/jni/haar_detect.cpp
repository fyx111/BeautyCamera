...
extern"C" {
    ...
    JNIEXPORT void JNICALL Java_com_example_beautycamera_SecondActivity_initLoad(JNIEnv* env, jobject, jstring haarfilePath)
    {
    ...
    JNIEXPORT void JNICALL Java_com_example_beautycamera_SecondActivity_faceDetection(JNIEnv*, jobject, jlong addrRgba)
    {
        int flag = 1000;
    ...
    JNIEXPORT void JNICALL Java_com_example_beautycamera_SecondActivity_beautySkinFilter(JNIEnv*, jobject, jlong addrsrc, jlong addrdst, jfloat sigma, jboolean blur)
    {
        bool flag = (bool)blur;
        Mat& src = *(Mat*)addrsrc;
        Mat& dst = *(Mat*)addrdst;
